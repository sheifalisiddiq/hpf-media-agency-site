...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "short-form content agency UAE",
    "content creation agency Dubai",
    "organic social media growth UAE",
    "social media management UAE",
    "video marketing agency UAE",
    "short form video production UAE",
    "content strategy Dubai",
    "personal branding UAE",
    "UAE SME marketing",
    "TikTok for business UAE",
    "Instagram growth strategy UAE",
    "viral content UAE",
    "organic content strategy Dubai",
    "creator-led marketing UAE",
  ],
